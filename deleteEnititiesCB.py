...
if __name__ == '__main__':
    ...
    print("[INFO] ["+str(dt.utcnow())+"] Starts Delete TrafficFlowObserved data from CB")
    ...
    while i <= 100:
        ...
        r = requests.get(url=CB_URL_TO_SEND_DATA+"?type=TrafficFlowObserved&limit=1000", timeout=300, data='', headers=headersGet)
